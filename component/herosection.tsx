...
import { Calendar, Star, Stethoscope, Award, Users, CheckCircle } from "lucide-react";
  ...
  return (
    <>
      ...
      >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center pb-5">
            ...
            <div className="space-y-6 lg:space-y-8 relative z-10 order-2 lg:order-1 slide-in-left">
              ...
              <div className="space-y-4">
                ...
                >
                  Best Hair Transplant In Bangalore, Performed by MD, Gold Medalist, Dr. Priyanka Raj
                </h1>
                <p 
                  className="text-base md:text-lg lg:text-lg leading-relaxed max-w-3xl"
                  style={{ color: colors.text }}
                >
                 Advanced hair restoration in Bangalore, driven by surgical expertise and natural-looking results.
                </p>
              </div>
              ...
              <div className="flex flex-wrap gap-4 pb-4">
                ...
                <div className="bg-white rounded-2xl shadow-lg p-4 border-2 flex-1 min-w-[200px]"
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-bold text-2xl number-spinner" style={{ color: colors.primary }}>
                        {counters.grafts.toLocaleString()}+
                      </p>
                      <p className="text-xs text-gray-600 font-semibold">Successful Grafts</p>
                    </div>
                  </div>
                </div>

                {/* Badge 2 - Premier Clinic */}
                <div className="bg-gradient-to-r from-amber-100 to-amber-50 rounded-2xl shadow-lg p-4 border-2 flex-1 min-w-[200px]"
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-bold" style={{ color: colors.text }}>Bangalore's Premier</p>
                      <p className="text-xs text-gray-600 font-semibold">Maxillofacial Clinic</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {/* Right Column - Clean Image with Slide-in Animation */}
            <div className="relative h-[400px] md:h-[450px] lg:h-[550px] order-1 lg:order-2 flex items-center justify-center slide-in-right">
              <div className="relative w-full h-full max-w-md lg:max-w-lg">
                ...
                <div className="absolute left-2 bottom-[8%] bg-white rounded-xl shadow-xl p-3 z-20 hidden lg:block border-2"
                  style={{ borderColor: colors.primaryLight }}
                >
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="font-bold text-xl number-spinner" style={{ color: colors.primary }}>
                        {counters.success}%
                      </p>
                ...
                <div className="absolute right-2 top-[8%] bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl shadow-xl p-3 z-20 hidden lg:block border-2 border-green-200">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-gray-600 font-semibold">Sterilization Standards</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="absolute bottom-[-1] left-0 right-0 bg-white/90 backdrop-blur-sm border-t-2 border-b-2 overflow-hidden z-20" style={{ borderColor: colors.primaryLight }}>
        ...
        <style jsx>{`
          ...
          .floating-circle {
            position: absolute;
            border-radius: 50%;
            background: linear-gradient(135deg, rgba(188, 156, 36, 0.12) 0%, rgba(188, 156, 36, 0.06) 100%);
          ...
          .circle-6 {
            ...
            left: 15%;
            animation-delay: 2s;
            background: linear-gradient(135deg, rgba(255, 184, 122, 0.12) 0%, rgba(255, 184, 122, 0.06) 100%);
          }
          ...
          .circle-7 {
            ...
            right: 40%;
            animation-delay: 5s;
            background: linear-gradient(135deg, rgba(244, 232, 193, 0.15) 0%, rgba(244, 232, 193, 0.08) 100%);
          }
          ...
          .circle-8 {
            ...
            left: 25%;
            animation-delay: 7s;
            background: linear-gradient(135deg, rgba(188, 156, 36, 0.1) 0%, rgba(255, 184, 122, 0.05) 100%);
          }
          ...
          .orb-1 {
            width: 300px;
            height: 300px;
            background: radial-gradient(circle, rgba(188, 156, 36, 0.4) 0%, transparent 70%);
            top: -100px;
            right: -100px;
            animation-delay: 0s;
          }
          ...
          .orb-2 {
            width: 250px;
            height: 250px;
            background: radial-gradient(circle, rgba(255, 184, 122, 0.3) 0%, transparent 70%);
            bottom: -50px;
            left: -50px;
            animation-delay: 2s;
          }
          ...
          .orb-3 {
            width: 200px;
            height: 200px;
            background: radial-gradient(circle, rgba(244, 232, 193, 0.5) 0%, transparent 70%);
            top: 50%;
            left: 50%;
            transform: translate(-50%, -50%);
            animation-delay: 4s;
