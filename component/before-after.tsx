      ...
      <div className="py-5 sm:py-16 md:py-6 lg:py-6 xl:py-8 bg-gradient-to-br from-yellow-50 to-yellow-100">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <div className="text-center mb-2 sm:mb-8 md:mb-10 lg:mb-6">
            <h2
              className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-4xl 2xl:text-6xl font-extrabold mb-2 sm:mb-3 md:mb-4"
            ...
            <p
              className="text-sm sm:text-base md:text-lg lg:text-lg text-gray-600 max-w-xs sm:max-w-md md:max-w-2xl lg:max-w-3xl xl:max-w-4xl mx-auto leading-relaxed sm:leading-relaxed"
          ...
          <div className="relative mb-3">
            ...
            <button
              ...
              className="hidden sm:block absolute right-0 top-1/2 -translate-y-1/2 translate-x-2 sm:translate-x-3 md:translate-x-4 lg:translate-x-6 xl:translate-x-8 z-10 w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 active:scale-95 shadow-lg"
              style={{ backgroundColor: colors.primary }}
...
// Before/After Card Component - FIXED MOBILE VIEW
      ...
      <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-3 md:gap-4 lg:gap-4">
        ...
        <div className="w-full sm:w-1/2 relative">
          <div className="relative rounded-lg sm:rounded-xl overflow-hidden shadow-md">
            ...
            {/* Before Label - COMPLETELY CHANGED FOR MOBILE */}
            <div
              className="absolute top-2 left-2 sm:top-3 sm:left-3 px-2 py-1 sm:px-4 sm:py-1.5 font-bold text-white text-xs sm:text-sm shadow-md"
              style={{
                backgroundColor: colors.navy,
                // REMOVED clipPath for mobile, keep only for desktop
                clipPath: "none",
              }}
            >
              Before
        ...
        <div className="w-full sm:w-1/2 relative">
          <div className="relative rounded-lg sm:rounded-xl overflow-hidden shadow-md">
            ...
            {/* After Label - COMPLETELY CHANGED FOR MOBILE */}
            <div
              className="absolute top-2 left-2 sm:top-3 sm:left-3 px-2 py-1 sm:px-4 sm:py-1.5 font-bold text-white text-xs sm:text-sm shadow-md"
              style={{
                backgroundColor: colors.navy,
