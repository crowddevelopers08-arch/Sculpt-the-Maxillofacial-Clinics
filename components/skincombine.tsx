...
export default function SkinCombinedSectionhair() {
    ...
    try {
      ...
      const response = await fetch('/api/leadshair', {
        ...
        body: JSON.stringify({
          ...
          source: 'https://www.sculpttmfc.com/skintreatment',
          formName: 'skintreatment'
        }),
      })
      ...
      setTimeout(() => {
        router.push('/thankyou-skintreatments')
      }, 500)
    } catch (error) {
          ...
          <div className="w-full max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-start">
              ...
              <div className="text-left">
                ...
                >
                  Achieving beautiful skin now is <span className="text-[#c99500]">easier than ever before!</span>
                </h2>
                ...
                >
                  <p>
                    At Sculpt The Maxillofacial Clinic, we know how skin issues can affect your confidence. 
                    From stubborn acne to pigmentation, scars, or fine lines, every concern deserves a 
                    personalised solution.
                  </p>

                  <p>
                    That's why we offer advanced, non-surgical treatments that combine science and artistry 
                    to help your skin look and feel its best. Every face is unique, and so is every plan.
                  </p>

                  <p>
                    Whether you want to soften ageing signs, brighten dull skin, or achieve lasting clarity, 
                    we design treatments that are safe, proven, and built just for you. Here, results are 
                    natural, never forced, and your journey is always supported from consultation to aftercare.
                  </p>
                </div>
              </div>
                      ...
                      <form ref={formRef} onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-2 text-left">
                          <Label htmlFor="treatment" className="text-black text-sm">
                            Which skin concern are you facing?
                          </Label>
                          <Select value={formData.treatment} onValueChange={(value) => handleInputChange("treatment", value)}>
                            ...
                            <SelectContent className="bg-white border-gray-300">
                              <SelectItem value="Acne & breakouts" className="text-black hover:bg-[#c99500]/10 text-left">
                                Acne & breakouts
                              </SelectItem>
                              <SelectItem value="Pigmentation & dark spots" className="text-black hover:bg-[#c99500]/10 text-left">
                                Pigmentation & dark spots
                              </SelectItem>
                              <SelectItem value="Fine lines & wrinkles" className="text-black hover:bg-[#c99500]/10 text-left">
                                Fine lines & wrinkles
                              </SelectItem>
                              <SelectItem value="Scars & marks" className="text-black hover:bg-[#c99500]/10 text-left">
                                Scars & marks
                              </SelectItem>
                              <SelectItem value="Dull & uneven skin tone" className="text-black hover:bg-[#c99500]/10 text-left">
