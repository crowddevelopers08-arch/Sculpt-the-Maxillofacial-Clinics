    ...
    <section className="relative overflow-hidden"style={{fontFamily: "'Outfit', sans-serif"}}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          ...
          <motion.h2 
            className="text-[40px] max-[470px]:text-[22px] md:text-4xl pt-[20px] max-[470px]:pt-5 font-bold text-center max-[470px]:mb-2 mb-6 text-[#0d0d0d] relative"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ 
        ...
        >
          <div className="relative pb-10 max-[470px]:pb-5 max-w-4xl mx-auto">
...
export default BeforeAfterGalleryskin;