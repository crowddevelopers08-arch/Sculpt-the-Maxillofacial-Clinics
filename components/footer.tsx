...
<a href="#contact-section">
            <Button className="w-full max-[426px]:text-[22px] bg-primary hover:bg-primary/90 text-black font-bold">Book Appointment</Button>
            </a>
          </div>
        </div>
        ...
        <div className="border-t border-primary/20 mt-12 pt-8 max-[426px]:pt-4 max-[426px]:mt-4 text-center">
          <p className="text-gray-400 max-[470px]:text-[11px] max-[470px]:mb-[50px] max-[426px]:mb-[0px]">© 2025 Sculpt The Maxillofacial Clinic. All rights reserved.</p>
        </div>
        <div className="border-t border-primary/20 mt-12 pt-8 max-[426px]:pt-4 max-[426px]:mt-4 text-center">
