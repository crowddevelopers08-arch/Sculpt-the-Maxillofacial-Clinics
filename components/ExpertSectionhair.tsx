...
export default function ExpertSectionhair() {
  return (
    <>
      <style jsx global>{`
      ...
      <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#0d0d0d] via-gray-900 to-[#0d0d0d] relative overflow-hidden max-[470px]:py-4 py-8 md:py-12" style={{fontFamily: "'Outfit', sans-serif"}}>
        {/* Animated Background */}
          ...
          <div className="grid lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12 xl:gap-16 items-center">
            ...
            <div className="text-white space-y-4 md:space-y-6 lg:space-y-8 order-2 lg:order-2">
              ...
              <div className="space-y-3 md:space-y-4 lg:space-y-6">
                <h2 className="text-[40px] max-[470px]:text-[22px] sm:text-4xl md:text-5xl font-black leading-tight">
              ...
              <div className="pt-2 md:pt-3 lg:pt-4">
                <div className="relative inline-flex items-center justify-center group">
                  ...
                  <a href="#hairform" className="relative inline-flex items-center justify-center px-6 py-3 sm:px-7 sm:py-3.5 md:px-8 md:py-4 lg:px-10 lg:py-4.5 xl:px-12 xl:py-5 text-sm sm:text-base md:text-lg lg:text-xl font-bold text-white bg-black border border-transparent rounded-full" role="button">
