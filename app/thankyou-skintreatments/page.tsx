        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mb-12">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-4">
              Your skin consultation request has been successfully submitted.
            </p>
          ...
          <div className="bg-gray-900/50 rounded-2xl p-8 mb-12 border border-[#d09a40]/20">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-gray-400 text-sm">Our skin experts review your concerns and medical history</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-[#d09a40]/20 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-gray-400 text-sm">We'll call you within 24 hours to schedule your skin assessment</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-[#d09a40]/20 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-gray-400 text-sm">Meet with Dr. Priyanka Raj for your personalized skin treatment plan</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/privacypolicy-skintreatment">
              <Button
                variant="outline"
